            ...
            <div class="card mt-4">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6 col-sm-12">
                                            ...
                                            <div class="p-3 m-3 rounded-2 text-white text-center bg-success">{{ ('High:
                                                > 80%') }}
                                            </div>
                                            <div class="p-3 m-3 rounded-2 text-white text-center bg-warning">
                                                {{__('Medium: >50% to 80%')}}</div>
                                            <div class="p-3 m-3 rounded-2 text-white text-center bg-danger">{{ __('Low:
                                                <=50%') }} </div>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-borderless">
                                                        <tbody>
                                                            <tr>
                                                                <th>{{ __('Leadership') }}:</th>
                                                                <td>{{ __('All managers and leaders who took part in the diagnosis process') }}</td>
                                                            </tr>
                                                            <tr>
                                                                <th>{{ __('HR Team') }}:</th>
                                                                <td>{{ __('Members of the HR team both managers and employyees – who take part of the diagnosis process') }}</td>
                                                            </tr>
                                                            <tr>
                                                                <th>{{ __('Employees') }}:</th>
                                                                <td>{{ __('Employees who take part of the diagnosis process.') }}
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        <div class="w-100">
                                            ...
                                            <div class="col-6 text-end function-lable mr-3">{{ __('Total Leaders Answers')
                                                }} {{
                                            ...
                                            @endif
                                            @if($prop_empResp>0)
                                            <div class="col-6 text-end function-lable mr-3">{{ __('Total Employee Answers')
                                                }} {{ $emp_res
                                                }} {{ __('out of') }} {{
                                                $prop_empResp }}</div>
                    ...
                    <div class="card-body" style="background-color: #DCE6F2 ; color:#376092 !important;">
                        <div class="row text-center">
                            <div class="m-1 rounded text-center h5 p-3" style="font-size: 1.7rem">
                                {{ __('People management performance – Leadership view average scores by people functions')}}
                            </div>
                        </div>
                ...
                <div id="Empaverages" class="card mt-4" style="letter-spacing: 0.065rem;">
                    ...
                    <div class="card-body" style="background-color: #DCE6F2 ; color:#376092 !important;">
                        <div class="row text-center">
                            <div class="m-1 rounded text-center h5 p-3" style="font-size: 1.7rem">
                                {{ __('People management performance – Employee view Average scores by people functions') }}
                            </div>
                        </div>
                        <div class="row row-function">
                            <?php
                ...
                <div id="heatmap" class="card mt-4" style="letter-spacing: 0.065rem;">
                    ...
                    <div class="card-body" style="background-color: #DCE6F2 ; color:#376092 !important;">
                        ...
                        <div class="row">
                            <div class="col-3 text-center heat-map heat-map-priority heat-map-priority-v">{{__('Priority by leaders') }}</div>
                                ...
                                @for ($j = 0; $j < 3; $j++) {{-- Start first --}} @if (($i==0 && $j==0) || ($i==0 &&
                                    ...
                                    <ul>
                                        ...
                                        @if ($pri['priority'] >50 && $pri['priority'] <80) @if ($pri['performance']
                                            <=50) <li class="text-white">{{ $pri['function'] }}</li>
                                            @endif
                                            @endif
                                            @endforeach
                                    </ul>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $type=="sec"? $entity->company_name_en: $entity->sector_name_en}}</td>
                                    <td>
                                        <a href="{{ route('survey-answers.result',[$id,$type=='sec'? 'comp':'sec',$entity->id]) }}"
