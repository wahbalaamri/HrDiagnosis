...
class SurveyAnswersController extends Controller
{
    ...
    public function result($id)
    {
        ...
        foreach ($functions as $function) {
            ...
            //leader performence
            $leader_performence_ = ["function" => $function->FunctionTitle, "function_id" => $function->id, "performance" => ($avgl * 100), "performancez" => ($avgl * 100)];
            array_push($leader_performences_, $leader_performence_);

            //hr performence

            $hr_performence_ = ["function" => $function->FunctionTitle, "function_id" => $function->id, "performance" => ($avgh * 100), "performancez" => ($avgh * 100)];
            array_push($hr_performences_, $hr_performence_);

            //emp performence
            $emp_performence_ = ["function" => $function->FunctionTitle, "function_id" => $function->id, "performance" => ($avge * 100), "performancez" => ($avge * 100)];
            ...
            $priority = ["priority" => $priorityVal, "function" => $function->FunctionTitle, "function_id" => $function->id, "performance" => $avgl, "performancez" => $avgl];
            array_push($priorities, $priority);
            $performence_ = ["function" => $function->FunctionTitle, "function_id" => $function->id, "performance" => ($avg * 100), "performancez" => ($avg * 100), 'overall_Practices' => $overall_Practices, 'leaders_practices' => $leaders_practices, 'hr_practices' => $hr_practices, 'emp_practices' => $emp_practices];
